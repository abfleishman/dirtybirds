#' Run raster functions in parallel if possible, but not really
#'
#' ECA includes this in here just cuz it is called in rasterPCA
...
#' Principal Component Analysis for Rasters from RSToolbox
#'
#' I was using the RStoolbox on my mac, but the dependencies for the whole package don't
#' compile on the Linux cluster.  So, I just took these few parts that I neeeded.
#'
